  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <View style={{ padding: 16 }}>
        ...
        <Text style={[styles.price, { color: colors.primary }]}>฿{model.price.toLocaleString()}</Text>
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity style={[styles.favBtn, { borderColor: colors.border, backgroundColor: colors.card }]}>
            ...
            <Text style={{ marginLeft: 8, color: colors.text }}>Add to favorite</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.arBtn, { backgroundColor: colors.primary }]} onPress={() => navigation.navigate('MainTabs', { screen: 'AR' })}>
...
const styles = StyleSheet.create({
  hero: { borderBottomLeftRadius: 18, borderBottomRightRadius: 18, overflow: 'hidden' },
  heroTop: { flexDirection: 'row', justifyContent: 'space-between', padding: 10 },
  iconBtn: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#00000012', alignItems: 'center', justifyContent: 'center' },
  preview: { width: '100%', height: 220, resizeMode: 'cover' },

  title: { fontSize: 22, fontWeight: '800' },
  price: { marginTop: 6, fontSize: 18, fontWeight: '900' },

  specBox: { borderWidth: 1, borderRadius: 12, padding: 12, marginTop: 12 },
