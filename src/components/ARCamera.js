...
const ARCamera = ({ selectedWheel, onCapture, onClose }) => {
  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderMove: Animated.event([null, { dx: wheelPosition.x, dy: wheelPosition.y }], { useNativeDriver: false }),
        ...
        {selectedWheel && (
          <View style={styles.wheelInfoPanel}>
            ...
            <View style={styles.wheelInfoSpecs}>
              ...
              {selectedWheel.weight ? <Text style={styles.specInfo}>{selectedWheel.weight}</Text> : null}
            </View>
          </View>
        )}
      </CameraView>
...
const styles = StyleSheet.create({
  ...
  wheelInfoPanel: { position: 'absolute', bottom: 150, left: 20, right: 20, backgroundColor: 'rgba(0,0,0,0.8)', borderRadius: 15, padding: 15 },
  wheelInfoTitle: { color: 'white', fontSize: 18, fontWeight: 'bold', textAlign: 'center', marginBottom: 5 },
  wheelInfoBrand: { color: 'rgba(255,255,255,0.8)', fontSize: 14, textAlign: 'center', marginBottom: 8 },
  wheelInfoPrice: { color: '#667eea', fontSize: 20, fontWeight: 'bold', textAlign: 'center', marginBottom: 10 },
  wheelInfoSpecs: { flexDirection: 'row', justifyContent: 'center', flexWrap: 'wrap' },
  specInfo: { color: 'white', fontSize: 10, backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 10, marginHorizontal: 3, marginVertical: 2 },
});
